...
fetch('./data.json')
    ...
    .then(jsondata => { 
        for (var i = 0; i < cards.length; i++) {
            ...
            hours[i].innerHTML = jsondata[i].timeframes.daily.current;
        ...
        weekly.addEventListener('click', () => {
            for (var i = 0; i < cards.length; i++) {
                titles[i].innerHTML = jsondata[i].title;
                hours[i].innerHTML = jsondata[i].timeframes.weekly.current;
        ...
        monthly.addEventListener('click', () => {
            for (var i = 0; i < cards.length; i++) {
                titles[i].innerHTML = jsondata[i].title;
                hours[i].innerHTML = jsondata[i].timeframes.monthly.current;
